...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function initWinesSlider() {
    ...
    $(".wines__block").slick({
      ...
      adaptiveHeight: true,
      prevArrow:
        '<button type="button" class="slick-prev"><img src="img/best-deals/arrow-left.svg"  alt="Previous"></button>',
      nextArrow:
        '<button type="button" class="slick-next"><img src="img/best-deals/arrow-right.svg" alt="Next"></button>',
